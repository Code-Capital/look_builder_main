...
export default function JacketTabSlider({openSidebar, setOpenSidebar, sidebarData}) {
    const {setJacketsData, selectedFabric} = useContext(SelectionContext);

    function updateSelectedIndex(OBJ, type) {
        setJacketsData((prevJacketsData) => {
