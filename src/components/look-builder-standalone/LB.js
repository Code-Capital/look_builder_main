...
import {GetDataLB, PostData} from "../../api/getData";

export default function LookBuilderStandalone() {
    ...
    const handleNextStep = () => {
        // let values = {selectedShirt, selectedPants, selectedShoes, selectedJacket}
