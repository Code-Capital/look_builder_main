...
export default function TrousersTabSlider({openSidebar, setOpenSidebar, sidebarData}) {
    const {setTrousersData, selectedFabric} = useContext(SelectionContext);

    function updateSelectedIndex(OBJ, type) {
        setTrousersData((prevJacketsData) => {
