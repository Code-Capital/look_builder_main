    ...
    return (
        <>
            <div className={"container-fluid tab"}>
                ...
                <div className={"container-fluid tab"}>
                    {!active && <div className="py-4 fw-light text-center h5 tab-heading">Add a waistcoat</div>}
                    {active && <div className="py-4 fw-light text-center h5 tab-heading">Customize your waistcoat</div>}
                    ...
                    <div className="tab-column">
                        ...
                        {active &&
                            <>
                                {selectionData && selectionData.WAISTCOAT.map((item, key) => {
                                    return (
